...
function Header() {
  ...
  return (
    <header>
      <nav className="fixed top-0 left-0 w-full h-auto bg-gray-800 z-10 flex items-center justify-between px-4 py-2">
        <h3 className="relative heading font-bold text-2xl mb-5 mt-5">News_Aggregator</h3>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="checkbox" className="checkbox-label ml-2">
